...
export async function validateCoupon(code, userId, courseId, coursePrice) {
    try {
        // Find coupon
        ...
        if (coupon.courseIds) {
            try {
                const allowedCourseIds = JSON.parse(coupon.courseIds);
...
export async function applyCoupon(couponId, userId, orderId, discountAmount) {
...
export async function getCoupons(page = 1, limit = 10) {

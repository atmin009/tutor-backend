...
export async function createPaymentSession(userId, courseId, paymentType, couponCode) {
    ...
    if (couponCode) {
        ...
        const couponResult = await validateCoupon(couponCode, userId, courseId, coursePrice);
